				...
				<typeProduct>
					...
					<template #img>
						<transition-group name="fade" tag="ul" class="type-info__product-list">
							<li v-show="slideIndex === 0" :key="0"><img :src="`../img/sustainabilitytest/img-product-item1-1.jpg`" alt=""></li>
							<li v-show="slideIndex === 1" :key="1"><img :src="`../img/sustainabilitytest/img-product-item1-2.jpg`" alt=""></li>
							<li v-show="slideIndex === 2" :key="2"><img :src="`../img/sustainabilitytest/img-product-item1-3.jpg`" alt=""></li>
						</transition-group>
					</template>
