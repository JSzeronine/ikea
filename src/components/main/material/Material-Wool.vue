<template>
    <div class="material-content wool">
        ...
        <div class="contents-wrap">
            <div class="visual-wrap">
                ...
                <img class="img-pc" :src="'./img/main/wool_product_img.jpg'" alt="">
                <img class="img-mb" :src="'./img/main/m_wool_product_img.jpg'" alt="">
            </div>
            <div class="text-wrap">
...
<script>
    ...
    import Visual from "@/components/main/material/Material-Wool-visual"
    ...
    export default {
        ...
        created() {
            this.language = this.$t( "contents.material.wool" );
        },
        ...
        mounted() {
            ...
            // step 0 hide
            timeline.fromTo( ".wool .step-con.step-a",
                {opacity:1, y:0}, {opacity:0, y:hideY, ease:Power2.easeIn,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".wool .progress-con.step-a",
                        start:"70% bottom",
                        end:"90% bottom"
                    }},
            )
            ...
            //step 1 show
            timeline.fromTo( ".wool .step-con.step-b",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                   scrollTrigger: {
                       scrub: scrub,
                       trigger: ".wool .progress-con.step-b",
                       start:"top bottom",
                       end:"30% bottom"
                   }},
           )
            ...
            gsap.set(".wool .step-con.step-b", {opacity:0})



            //step 3 show
            timeline.fromTo( ".wool .step-con.step-d .title-wrap p:nth-child(1)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                   scrollTrigger: {
                       scrub: scrub,
                       trigger: ".wool .progress-con.step-d",
                       start:"top bottom",
                       end:"30% bottom"
                   }},
           )
           ...
           //step 3 show
           timeline.fromTo( ".wool .step-con.step-d .title-wrap p:nth-child(2)",
               {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                   scrollTrigger: {
                       scrub: scrub,
                       trigger: ".wool .progress-con.step-d",
            ...
            //step 3 text color
           timeline.fromTo( ".wool .step-con.step-d .title-wrap",
               {color:"#000"}, {color:"#fff",
                   scrollTrigger: {
                       scrub: scrub,
                       trigger: ".wool .progress-con.step-d",
            ...
            gsap.set(".wool .step-con.step-d .title-wrap p", {opacity:0})
            ...
            .visual-wrap {
                ...
                .product-info {
                    ...
                    .product-item {
                        ...
                        padding: pxtovw414(50) pxtovw414(40);
                ...
                .contents-wrap {
                    .visual-wrap {
                        ...
                        .product-info {
                            ...
                            .product-item {
                                padding: pxtovw414(70) pxtovw414(40);
                                .name {
                                    margin-bottom: pxtovw414(6);
                                }
                                .info {
