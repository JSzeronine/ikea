<template>
    <div class="material-content cotton">
                ...
                <div class="step-wrap">
                    <div class="step-con step-a" v-show="stepIndex == 1">
                        <div class="title-wrap">
                            ...
                            <span class="meterial">COTTON</span>
                        </div>
                    </div>
        ...
        <div class="contents-wrap">
            <div class="visual-wrap">
                ...
                <img class="img-pc" :src="'./img/main/cotton_product_img.jpg'" alt="">
                <img class="img-mb" :src="'./img/main/m_cotton_product_img.jpg'" alt="">
            </div>
            <div class="text-wrap">
...
<script>
    ...
    import Visual from "@/components/main/material/Material-Cotton-visual"
    ...
    export default {
        ...
        created() {
            this.language = this.$t( "contents.material.cotton" );
        },
        ...
        mounted() {
            ...
            timeline.fromTo( ".cotton .step-con.step-a",
                {opacity:1, y:0}, {opacity:0, y:hideY, ease:Power2.easeIn,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".cotton .progress-con.step-a",
                        start:"50% bottom",
                        end:"100% bottom"
                    }},
            )
            ...
            //step 1
            timeline.fromTo( ".cotton .step-con.step-b",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".cotton .progress-con.step-b",
                        start:"top bottom",
                        end:"30% bottom"
                    }},
            )
            ...
            //step 3
            timeline.fromTo( ".cotton .step-con.step-d .title-wrap p:nth-child(1)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".cotton .progress-con.step-d",
                        start:"top bottom",
                        end:"30% bottom"
                    }},
            )

            timeline.fromTo( ".cotton .step-con.step-d .title-wrap p:nth-child(2)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".cotton .progress-con.step-d",
            ...
            timeline.fromTo( ".cotton .step-con.step-d .title-wrap",
                {color:"#000"}, {color:"#fff",
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".cotton .progress-con.step-d",
            ...
            .visual-wrap {
                ...
                .product-info {
                    ...
                    .product-item {
                        ...
                        padding: pxtovw414(150) 0 0 pxtovw414(40);
