<template>
    <div class="material-content food">
                ...
                <div class="step-wrap">
                    <div class="step-con step-a" v-show="stepIndex == 1">
                        <div class="title-wrap">
                            ...
                            <span class="meterial">IKEA Food</span>
                        </div>
                    </div>
        ...
        <div class="contents-wrap">
            <div class="visual-wrap">
                ...
                <img class="img-pc" :src="'./img/main/food_product_img.jpg'" alt="">
                <img class="img-mb" :src="'./img/main/m_food_product_img.jpg'" alt="">
            </div>
            <div class="text-wrap">
...
<script>
    ...
    import Visual from "@/components/main/material/Material-Food-visual"
    ...
    export default {
        ...
        created() {
            this.language = this.$t( "contents.material.food" );
        },
        ...
        mounted() {
            ...
            timeline.fromTo( ".food .step-con.step-a",
                {opacity:1, y:0}, {opacity:0, y:hideY, ease:Power2.easeIn,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".food .progress-con.step-a",
                        start:"50% bottom",
                        end:"100% bottom"
                    }},
            )
            ...
            //step 1
            timeline.fromTo( ".food .step-con.step-b",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".food .progress-con.step-b",
                        start:"top bottom",
                        end:"30% bottom"
                    }},
            )
            ...
            //step 3
            timeline.fromTo( ".food .step-con.step-d .title-wrap p:nth-child(1)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".food .progress-con.step-d",
                        start:"top bottom",
                        end:"30% bottom"
                    }},
            )

            timeline.fromTo( ".food .step-con.step-d .title-wrap p:nth-child(2)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".food .progress-con.step-d",
            ...
            timeline.fromTo( ".food .step-con.step-d .title-wrap",
                {color:"#000"}, {color:"#fff",
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".food .progress-con.step-d",
                        ...
                        .price {
                            ...
                            &.food {
                                ...
                                &:after {
                                    ...
                                    left: pxtovw414(-5); top: pxtovw414(-2);
                                    z-index: 0;
                                    padding: pxtovw414(4) pxtovw414(10);
                                }
                                ...
                                &:before {
                                    ...
                                    width: 100%;
                                    height: 100%;
                                    background-color: #E0014F;
                                    left: pxtovw414(-1); top: pxtovw414(2);
                                    z-index: 0;
                                    padding: pxtovw414(4) pxtovw414(10);
                                }
