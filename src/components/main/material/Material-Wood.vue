<template>
    <div class="material-content wood">
        ...
        <div class="contents-wrap">
            <div class="visual-wrap">
                ...
                <img class="img-pc" :src="'./img/main/wood_product_img.jpg'" alt="">
                <img class="img-mb" :src="'./img/main/m_wood_product_img.jpg'" alt="">
            </div>
            <div class="text-wrap">
...
<script>
    ...
    import Visual from "@/components/main/material/Material-Wood-visual"
    ...
    export default {
        ...
        created() {
            this.language = this.$t( "contents.material.wood" );
        },
        ...
        mounted() {
            ...
            timeline.fromTo( ".material-content.wood .arrow-btn",
                {opacity:1, y:0}, {opacity:0, ease:Power2.easeIn,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".wood .progress-con.step-a",
                        start:"top bottom",
                        end:"50% bottom"
            ...
            timeline.fromTo( ".wood .step-con.step-a",
            ...
            //step 1
            timeline.fromTo( ".wood .step-con.step-b",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".wood .progress-con.step-b",
                        start:"top bottom",
                        end:"30% bottom"
                    }},
            )
            ...
            //step 3
            timeline.fromTo( ".wood .step-con.step-d .title-wrap p:nth-child(1)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".wood .progress-con.step-d",
                        start:"top bottom",
                        end:"30% bottom"
                    }},
            )

            timeline.fromTo( ".wood .step-con.step-d .title-wrap p:nth-child(2)",
                {opacity:0, y:showY}, {opacity:1, y:0, ease:Power2.easeOut,
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".wood .progress-con.step-d",
            ...
            timeline.fromTo( ".wood .step-con.step-d .title-wrap",
                {color:"#000"}, {color:"#fff",
                    scrollTrigger: {
                        scrub: scrub,
                        trigger: ".wood .progress-con.step-d",
            ...
            .visual-wrap {
                ...
                .product-info {
                    ...
                    .product-item {
                        position: absolute;
                        bottom: 0; left: 0;
                        padding: 0 0 pxtovw414(30) pxtovw414(40);
