...
<!--                            <img :src="`./img/teaser/teaser_play_btn.png`" alt="재생 버튼">-->
                            <img :src="`./img/common/btn-play-box-white.png`" alt="재생 버튼">
                        </a>
                    </div>
            ...
            <div class="play-wrap__bg">
                <div class="home-wrap__bg-video__bx">
                    <video class="img-pc bg-pc" :src="`./img/teaser/pc_play_pre.mp4`" autoplay playsinline muted loop></video>
                    <video class="img-mb bg-m" :src="`./img/teaser/m_play_pre.mp4`" autoplay playsinline muted loop></video>
                </div>

                <transition name="fade">
                    <div class="video-player" v-show="pcVideoPlay">
                        <video class="img-pc bg-pc" :src="`./img/teaser/pc_play_60sec.mp4`" type="video/mp4" playsinline muted controls></video>
                    </div>
                </transition>
            </div>
        </div>
            ...
            <div class="popup" v-show="showPlay">
                <div class="bg-wrap">
                    <div class="popup-content">
                        ...
                        <video class="img-mb bg-m" :src="`./img/teaser/pc_play_60sec.mp4`" type="video/mp4" playsinline muted controls></video>
                    </div>
                </div>
            </div>
        </transition>
...
export default {
    ...
    created() {
        this.language = this.$t( "contents.tvcf" );
    },
